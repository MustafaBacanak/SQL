...
Order by maas desc -- Order By maas Desc eklenirse buyukten kucuge siralar
...
order by maas -- Order By eklenirse kucukten buyuge siralar
...
/*
SQL INTERSECT operatörü, 2 veya daha fazla SELECT ifadesinin sonuçlarını döndürmek içi	n kullanılır. 
...
SELECT isim from personel where maas<5000 EXCEPT SELECT isim FROM personel WHERE sirket='Honda';
